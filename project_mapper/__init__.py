...
Scans a software project (Python AST + optional LLM enrichment) and populates
an AethvionDB database with a rich knowledge graph of modules, classes,
functions, dependencies, and their relationships.
