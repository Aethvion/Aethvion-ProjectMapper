"""
project_mapper/db/name_index.py
...
Storage: <DATA_DIR>/default/name_index.json  (or per-db path when constructed explicitly)
...
_DEFAULT_INDEX_PATH = DATA_DIR / "default" / "name_index.json"
